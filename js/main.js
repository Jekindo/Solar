...
$('.info-tabs__item').removeClass('info-tabs__items--active');
$(this).addClass('info-tabs__items--active');

$('.info-tabs_content').removeClass('info-tabs_content--active');
$($(this).attr('href')).addClass('info-tabs_content--active');


});

$('.info-slider, .clienst-slider').slick({
    fade: true,
